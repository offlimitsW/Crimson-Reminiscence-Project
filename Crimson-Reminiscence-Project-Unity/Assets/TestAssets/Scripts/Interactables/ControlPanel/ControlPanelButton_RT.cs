...
public class ControlPanelButton_RT : Interactable
{
    [Header("Paramaters")]
    public bool hasBeenPressed = false;
    public bool canBeenPressed = true;
    public bool button_RTPressed = false;
    ...
    Animator anim;
    public static ControlPanelButton_RT Instance;
    ...
    {
        if (ControlPanelButton_MRL.Instance.hasBeenPressed == true && ControlPanelMainFrame.Instance.mainFramePowered == true && hasBeenPressed == false && canBeenPressed == true)
        {
            audioSource.PlayOneShot(interact[UnityEngine.Random.Range(0, interact.Length - 1)]);
            hasBeenPressed = true;
            button_RTPressed = true;
