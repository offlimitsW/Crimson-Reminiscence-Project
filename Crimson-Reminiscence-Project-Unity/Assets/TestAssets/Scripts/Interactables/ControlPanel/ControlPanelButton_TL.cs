...
public class ControlPanelButton_TL : Interactable
{
    [Header("Paramaters")]
    public bool hasBeenPressed = false;
    public bool canBeenPressed = true;
    public bool button_TLPressed = false;
    ...
    Animator anim;
    public static ControlPanelButton_TL Instance;
    ...
    {
        if (ControlPanelButton_RL.Instance.hasBeenPressed == true && ControlPanelMainFrame.Instance.mainFramePowered == true && hasBeenPressed == false && canBeenPressed == true)
        {
            audioSource.PlayOneShot(interact[UnityEngine.Random.Range(0, interact.Length - 1)]);
            hasBeenPressed = true;
            button_TLPressed = true;
        ...
        else if(ControlPanelMainFrame.Instance.mainFramePowered == true && hasBeenPressed == false)
        {
            ...
            ControlPanelButton_MRL.Instance.hasBeenPressed = false;
            ControlPanelButton_MRL.Instance.canBeenPressed = true;
            ControlPanelButton_MRL.Instance.button_MRLPressed = false;

            ControlPanelButton_RT.Instance.hasBeenPressed = false;
            ControlPanelButton_RT.Instance.canBeenPressed = true;
            ControlPanelButton_RT.Instance.button_RTPressed = false;

            ControlPanelButton_MR.Instance.hasBeenPressed = false;
            ControlPanelButton_MR.Instance.canBeenPressed = true;
            ControlPanelButton_MR.Instance.button_MRPressed = false;

            ControlPanelButton_MLL.Instance.hasBeenPressed = false;
            ControlPanelButton_MLL.Instance.canBeenPressed = true;
            ControlPanelButton_MLL.Instance.button_MLLPressed = false;

            ControlPanelButton_RL.Instance.hasBeenPressed = false;
            ControlPanelButton_RL.Instance.canBeenPressed = true;
            ControlPanelButton_RL.Instance.button_RLPressed = false;
