...
public class ControlPanelButton_MR : Interactable
{
    [Header("Paramaters")]
    public bool hasBeenPressed = false;
    public bool canBeenPressed = true;
    public bool button_MRPressed = false;
    ...
    Animator anim;
    public static ControlPanelButton_MR Instance;
    ...
    {
        if (ControlPanelButton_RT.Instance.hasBeenPressed == true && ControlPanelMainFrame.Instance.mainFramePowered == true && hasBeenPressed == false && canBeenPressed == true)
        {
            audioSource.PlayOneShot(interact[UnityEngine.Random.Range(0, interact.Length - 1)]);
            hasBeenPressed = true;
            button_MRPressed = true;
