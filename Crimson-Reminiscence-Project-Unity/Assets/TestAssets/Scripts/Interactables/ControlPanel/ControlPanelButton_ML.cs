...
public class ControlPanelButton_ML : Interactable
{
    [Header("Paramaters")]
    public bool hasBeenPressed = false;
    public bool canBeenPressed = true;
    public bool button_MLPressed = false;
    ...
    Animator anim;
    public static ControlPanelButton_ML Instance;
    ...
    {
        if (ControlPanelButton_LB.Instance.hasBeenPressed == true && ControlPanelMainFrame.Instance.mainFramePowered == true && hasBeenPressed == false && canBeenPressed == true)
        {
            audioSource.PlayOneShot(interact[UnityEngine.Random.Range(0, interact.Length - 1)]);
            hasBeenPressed = true;
            button_MLPressed = true;
