...
public class ControlPanelButton_MLL : Interactable
{
    [Header("Paramaters")]
    public bool hasBeenPressed = false;
    public bool canBeenPressed = true;
    public bool button_MLLPressed = false;
    ...
    Animator anim;
    public static ControlPanelButton_MLL Instance;
    ...
    {
        if (ControlPanelButton_MR.Instance.hasBeenPressed == true && ControlPanelMainFrame.Instance.mainFramePowered == true && hasBeenPressed == false && canBeenPressed == true)
        {
            audioSource.PlayOneShot(interact[UnityEngine.Random.Range(0, interact.Length - 1)]);
            hasBeenPressed = true;
            button_MLLPressed = true;
