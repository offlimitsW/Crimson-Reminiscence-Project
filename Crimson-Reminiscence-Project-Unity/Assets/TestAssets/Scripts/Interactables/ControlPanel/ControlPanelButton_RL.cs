...
public class ControlPanelButton_RL : Interactable
{
    [Header("Paramaters")]
    public bool hasBeenPressed = false;
    public bool canBeenPressed = true;
    public bool button_RLPressed = false;
    ...
    Animator anim;
    public static ControlPanelButton_RL Instance;
    ...
    {
        if (ControlPanelButton_MLL.Instance.hasBeenPressed == true && ControlPanelMainFrame.Instance.mainFramePowered == true && hasBeenPressed == false && canBeenPressed == true)
        {
            audioSource.PlayOneShot(interact[UnityEngine.Random.Range(0, interact.Length - 1)]);
            hasBeenPressed = true;
            button_RLPressed = true;
